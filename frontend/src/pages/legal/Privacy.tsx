...
export const PrivacyPage: React.FC = () => (
  <LegalLayout title="Privacy Policy" updated="August 1, 2026">
    ...
    <p>
      ...
      optional profile preferences such as your timezone.
    </p>
    ...
    <p>
      ...
      FreshBooks we request least-privilege OAuth scopes via the official FreshBooks SDK. GentleTap
      reads invoices and customer records to power reminders and payment detection. We do not create,
      modify, or delete accounting records in your connected company.
    </p>
    <p>
      Accounting data is used only for your account. We do not aggregate one user's QuickBooks or
      FreshBooks data across customers or share it with another user. If you disconnect an
    ...
    <p>
      Reminder drafts are generated using AI providers (ZAI / Kimi). We send invoice context (amounts,
      due dates, client names, payment history) solely to produce reminder text. We do not use your
    ...
    <ul>
      <li><strong>Intuit QuickBooks</strong> — accounting data sync, when connected</li>
      <li><strong>FreshBooks</strong> — accounting data sync, when connected</li>
      <li><strong>Google</strong> — sign-in (OAuth) and Gmail send, when you connect Google</li>
      <li><strong>Resend</strong> — transactional email and domain sender verification</li>
      <li><strong>Paddle</strong> — subscription billing and payment processing (Merchant of Record)</li>
      <li><strong>Twilio / Meta WhatsApp</strong> — WhatsApp message delivery, when enabled</li>
      <li><strong>ZAI / Moonshot AI (Kimi)</strong> — AI draft generation for reminder messages</li>
      <li><strong>Self-hosted infrastructure</strong> — PostgreSQL and Redis on our VPS</li>
    </ul>
    <p>Each provider's own privacy policy governs their handling of data they process on our behalf.</p>

    <h2>Data retention</h2>
    <ul>
      <li><strong>Account data</strong> — retained while your account is active; deleted within 30 days of account deletion.</li>
      <li><strong>QuickBooks / FreshBooks / Gmail tokens</strong> — deleted when you disconnect the integration or delete your account.</li>
      <li><strong>Reminder logs</strong> — retained for up to 24 months, then deleted or anonymized.</li>
      <li><strong>Billing records</strong> — retained as required by tax law (typically 7 years), handled by Paddle as Merchant of Record.</li>
    </ul>
    ...
    <ul>
      <li><strong>Export</strong> — download a copy of your data from Settings in the dashboard.</li>
      <li><strong>Delete</strong> — permanently delete your account and associated data from Settings. Cancel any active Paddle subscription first via the billing portal.</li>
      <li><strong>Disconnect integrations</strong> — revoke QuickBooks, FreshBooks, Gmail, or WhatsApp access at any time from Settings.</li>
      <li>
    ...
    <h2>Contact</h2>
    <p>
      Privacy questions: <a href={`mailto:${LEGAL.privacyEmail}`}>{LEGAL.privacyEmail}</a>
      <br />
