...
export const RefundPage: React.FC = () => (
  <LegalLayout title="Refund Policy" updated="June 18, 2026">
    ...
    <p>
      ...
      {LEGAL.refundWindowDays}-day guarantee window, your access continues until the end of the
      current billing period and no partial refund is issued for unused time, unless required by
      applicable consumer law in your jurisdiction.
    </p>
    <p>You can cancel anytime from Settings → Billing (Paddle customer portal).</p>

    <h2>WhatsApp message packs</h2>
    <p>
      One-time WhatsApp message pack purchases are refundable within {LEGAL.refundWindowDays} days
      if credits have not been used. Once credits are added to your account and consumed, those
      purchases are non-refundable except where consumer law requires otherwise.
    </p>

    <h2>Free plan</h2>
    <p>The Starter (free) plan does not involve charges and is not subject to this refund policy.</p>
