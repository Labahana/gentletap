...
export function softwareApplicationJsonLd() {
  return {
    ...
    featureList: [
      "QuickBooks Online + FreshBooks invoice sync (read-only access)",
      "AI-personalized payment reminder emails per invoice and client",
      "Client payment profiling and risk-aware tone selection",
      "Send from Gmail or verified custom domain",
      "Multi-step escalation sequences (due date through 30+ days overdue)",
      "WhatsApp payment reminders on Pro+ ($39/mo) and Team — email first, WhatsApp ~3h later on steps 1–3",
      "Preview and approve drafts before first send",
      "Automatic stop when invoice balance hits zero",
    ...
    audience: {
      "@type": "Audience",
      audienceType: "Freelancers and consultants using QuickBooks Online or FreshBooks and Gmail",
    },
  };
}
