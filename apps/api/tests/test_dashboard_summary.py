...
@patch("gentletap.services.invoice_source.source_counts_for_user", return_value={"quickbooks_count": 0, "upload_count": 0, "upload_needs_attention": 0})
...
def test_build_invoices_summary_passes_profile_to_plan_usage(
    ...
    invoice_q.filter.return_value.first.return_value = None
