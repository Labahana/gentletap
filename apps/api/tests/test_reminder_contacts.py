...
def test_effective_reminder_phone_prefers_invoice_override():
...
def test_effective_reminder_phone_falls_back_to_client():
    client = SimpleNamespace(phone="+15551111111")
    inv = SimpleNamespace(reminder_phone=None, client=client)
    assert effective_reminder_phone(inv) == "+15551111111"
