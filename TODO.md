...
- [x] Paddle billing (Option B: Starter free / Pro $19 / Pro+ $39 / Team $59)
...
- [ ] Intuit, Google, OpenAI, Paddle, Resend keys in production `.env`
- [ ] Google OAuth verification (2–4 weeks) for Gmail in production
- [ ] Twilio WhatsApp Business setup (Pro channel)
- [ ] Register webhook URLs: QB, Paddle, Resend, Twilio → `https://gentletap.co/v1/webhooks/*`
